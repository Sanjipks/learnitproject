...
{/* <nav className = "fixed top-0 z-50 bg-gray-300 border-gray-200 dark:bg-gray-900 dark:border-gray-700">
 ...
 <DarkModeToggle/>
    ...
    <div className={`${expand} w-full md:block md:w-auto sm:fixed sm:mt-64 md:mt-0 md:ml-48`} id="navbar-dropdown">
      <ul className="flex flex-col overflow-hidden font-medium p-4 md:p-0 mt-4 border border-gray-300 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-gray-300 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-900">
        <li>
    ...
    <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="m1 1 4 4 4-4"/>
            ...
            {/* <!-- Dropdown menu --> */}
            <div id="dropdownNavbar" className={`z-10 ${subExpand} fixed md:ml-[-128] lg:mt-5 mt-4 font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-800 dark:divide-gray-800`}>
                <ul className="flex flex-wrap  mx-0 pr-5 text-sm text-gray-900 dark:text-gray-200" aria-labelledby="dropdownLargeButton">
                  <li>
