...
<nav className = "bg-gray-300 border-gray-200 dark:bg-gray-900 dark:border-gray-700">
 ...
 <DarkModeToggle/>
    ...
    <div className={`${expand} w-full md:block md:w-auto`} id="navbar-dropdown">
    ...
    <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="m1 1 4 4 4-4"/>
            ...
            {/* <!-- Dropdown menu --> */}
            <div id="dropdownNavbar" className={`z-10 ${subExpand} font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600`}>
