  ...
  return (
    <div
      className={` ${viewBox ? "h-5/6" : "h-10"} ${
        closeBox && "hidden"
      } fixed bottom-1 z-10  justify-center border border-gray-900 dark:border-gray-100 ml-1 rounded-md bg-slate-100 dark:bg-slate-700`}
    >
      <h1 className=" flex justify-between border border-gray-900 z-10 dark:border-gray-100 h-10 mx-auto text-center py-2 rounded-t-md dark:text-slate-200 text-slate-900">
