      ...
      {userState === "true" && (
        <div
          className={`${viewBox ? "h-5/6" : "h-10"} ${
            closeBox && "hidden"
          } fixed bottom-1 z-10 flex flex-col max-w-md w-[400px] ml-1 justify-center border border-gray-900 dark:border-gray-100  rounded-md bg-slate-100 dark:bg-slate-700`}
        >
