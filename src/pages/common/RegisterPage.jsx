    ...
    <div className="min-h-screen h-auto flex flex-col xm:gap-4 bg-gray-500 dark:bg-gray-800 dark:border-gray-700 text-gray-900 dark:text-white">
      <div className="items-center justify-start md:my-40 sm:my-20 px-2">
        <div className="max-w-screen-xl w-full sm:h-auto sm:m-auto flex md:flex-row xm:flex-col-reverse">
          <section className="flex  justify-center items-center w-full sm:rounded-br-xl md:rounded-br-none sm:rounded-bl-xl md:rounded-tl-xl shadow-md">
            <Carasoul images={images} buttonShow={false} />
          </section>
          <section className="flex md:h-[756px] justify-center items-center min-h-max w-full dark:bg-gray-900 bg-gray-400 md:rounded-br-xl sm:rounded-tr-xl sm:rounded-tl-xl md:rounded-tl-none sm:mt-8 md:mt-0 px-2">
