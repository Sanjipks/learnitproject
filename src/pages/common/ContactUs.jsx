...
const ContactUs = () => {
  return (
    <div className="min-h-screen h-auto xl:-mb-64 flex flex-col xm:gap-4  justify-start bg-gray-500 dark:bg-gray-800 dark:border-gray-700 text-gray-900 dark:text-white">
