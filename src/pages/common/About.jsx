...
export default function About() {
  return (
    <div className="min-h-dvh flex flex-col sm:items-center sm:mb-auto dark:bg-gray-600 dark:border-gray-800 bg-gray-200 border-gray-200 ">
      <section className=" bg-gray-200 dark:bg-gray-600 md:w-1/2 sm:w-full sm:mt-2 sm:mb-4 border dark:border-black ">
        <div className=" flex flex-col items-center md:h-dvh px-6 mx-auto lg:pt-6 ">
          ...
          <p className="mt-24 dark:text-slate-300 text-slate-900 xxl:text-3xl text-wrap sm:mx-2 mx-24 text-left">
      ...
      <section className="mb-24 bg-gray-200 dark:bg-gray-600 md:w-1/2 sm:w-full mt-8 sm:mt-2 border dark:border-black ">
        <div className=" flex flex-col items-center px-6 mx-auto lg:pt-6 ">
          ...
          <ul className="mt-20 dark:text-slate-300 text-slate-900 xxl:text-3xl text-wrap mx-24 sm:mx-2 list-disc text-left">
            ...
            <li className="m-4">
              ...
              <ul>
                <li className="m-4">
                  Expand service offerings to include emerging technologies like
            ...
            <li className="m-4">
              ...
              <ul>
                ...
                <li className="m-4">
                  Develop and offer loyalty programs or discounts for long-term
                  clients.
                </li>
              </ul>
            </li>
            ...
            <li className="m-4">
              ...
              <ul>
                <li className="m-4">
                  Position the company as a thought leader in the IT consulting
                  industry through whitepapers, webinars, and speaking
                  engagements.
                </li>
                <li className="m-4">
            ...
            <li className="m-4">
              ...
              <ul>
                <li className="m-4">
                  ...
                  certifications related to environmental and social governance
                  (ESG).
                </li>
                <li className="m-4">
            ...
            <li className="m-4">
              ...
              <ul>
                ...
                <li className="m-4">
                  Develop internship and mentorship programs to support the next
            ...
            <li className="m-4">
              ...
              <ul>
                ...
                <li className="m-4">
                  Adapt services to meet the needs of diverse markets and comply
