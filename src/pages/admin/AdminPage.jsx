  ...
  return (
    <>
      {userRole === "admin" && loginState === "true" ? (
        <div className="min-h-dvh h-auto pb-16 px-4 flex flex-col justify-items-center justify-between  bg-gray-500 dark:bg-gray-800 dark:border-gray-700 text-gray-900 dark:text-white">
          ...
          <div className="max-w-screen-xl justify-center h-auto w-full flex md:flex-col sm:flex-col sm:items-center mx-auto">
            <section className="sm:min-h-dvh rounded-xl bg-gray-200 dark:bg-gray-600  sm:w-full mt-8 border dark:border-black ">
              <div className=" flex flex-col items-center p-6 mx-auto lg:pt-6 ">
                ...
                <div className="mt-16 xm:mx-4 md:mx-auto">
                  <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-24">
            ...
            <section className="sm:min-h-dvh rounded-xl  bg-gray-200 dark:bg-gray-600 sm:w-full mt-8 border dark:border-black">
              <div className=" flex flex-col pt-6 items-center sm:h-auto px-6 mx-auto lg:pt-6 ">
                <div className="w-full  bg-gray-100 rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                  <h1 className="text-center text-xl font-bold leading-tight tracking-tight text-gray-900 md:text-2xl dark:text-white p-8">
                    My Items
                  </h1>
